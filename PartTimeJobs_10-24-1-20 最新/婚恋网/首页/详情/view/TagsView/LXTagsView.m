...
-(void)buildTags{
    ...
    for (int i = 0; i<_dataA.count; i++) {
        ...
        UIButton *button =[UIButton LXButtonNoFrameWithTitle:_dataA[i] titleFont:self.tagFont Image:nil backgroundImage:nil backgroundColor:kRGBA(252, 240, 242, 1) titleColor:kRGBA(255, 92, 121, 1)];
