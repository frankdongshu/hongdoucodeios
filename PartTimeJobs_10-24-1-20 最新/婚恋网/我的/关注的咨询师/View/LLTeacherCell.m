...
-(void)setInfoModel:(LLTeatherModel *)infoModel{
    ...
    self.schoolLabel.text = _infoModel.school;
    self.positionLabel.text = _infoModel.identity;
    self.maiorView.titleString = _infoModel.major;
    self.eduView.titleString = _infoModel.education;
    self.sexImageView.image = [UIImage imageNamed:_infoModel.sex];
    if (_type == FollowType) {
