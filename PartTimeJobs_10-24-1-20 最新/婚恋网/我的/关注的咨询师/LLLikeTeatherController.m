...
- (void)loadNewData{
    ...
    [HLHTTPSessionManager postDataWithNSString:@"/mind/lists" withDictionary:parmas success:^(NSDictionary * _Nonnull dictionary) {
...
- (void)requestCancelFollowWithRow:(NSInteger)row {
    ...
    [HLHTTPSessionManager postDataWithNSString:@"/mind/cancel" withDictionary:params success:^(NSDictionary * _Nonnull dictionary) {
