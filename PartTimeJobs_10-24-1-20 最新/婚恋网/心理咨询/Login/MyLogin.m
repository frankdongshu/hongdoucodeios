...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:self.teaching forKey:@"teaching"];
    [aCoder encodeObject:self.cost_low forKey:@"cost_low"];
    [aCoder encodeObject:self.cost_high forKey:@"cost_high"];
    ...
    [aCoder encodeObject:self.papers forKey:@"papers"];
...
- (nullable instancetype)initWithCoder:(NSCoder *)aDecoder
{
    if (self = [super init]) {
        ...
        self.teaching = [aDecoder decodeObjectForKey:@"teaching"];
        self.cost_low = [aDecoder decodeObjectForKey:@"cost_low"];
        self.cost_high = [aDecoder decodeObjectForKey:@"cost_high"];
        ...
        self.papers = [aDecoder decodeObjectForKey:@"papers"];
