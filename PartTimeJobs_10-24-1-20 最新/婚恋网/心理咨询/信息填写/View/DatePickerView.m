...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view{
    ...
    [pickerView.subviews[1] setBackgroundColor:REDColor];
//    [pickerView.subviews[2] setBackgroundColor:REDColor];
...
- (void)sureAction{
    ...
    monthStr = ([monthStr integerValue] < 10 ? [NSString stringWithFormat:@"0%@",monthStr]:monthStr);
    dayStr = ([dayStr integerValue] < 10 ? [NSString stringWithFormat:@"0%@",dayStr]:dayStr);
