...
- (void)sureClick {
    ...
    NSDictionary *parmas = @{
        ...
        @"intel":self.dataArray[self.seleIndex][@"title"]
    };

    [HTTPSessionManger postDataWithNSString:@"/coach/intelligence" withDictionary:parmas success:^(NSDictionary * _Nonnull dictionary) {
        NSLog(@"%@",dictionary);
...
- (void)getAptitudeViewList {
    ...
    [HTTPSessionManger postDataWithNSString:@"/coach/get_intelligence" withDictionary:parmas success:^(NSDictionary * _Nonnull dictionary) {
