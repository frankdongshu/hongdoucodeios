//
//  TeacherFindController.m
//  PartTimeJobs
//
//  Created by 维康1 on 2020/4/29.
...
#import "TeacherSquareController.h"
#import "HLUserDetailInfoViewController.h"
#import "HLReleaseViewController.h"

@interface TeacherFindController ()<JXCategoryViewDelegate,JXCategoryListContainerViewDelegate>

@property (nonatomic, strong) JXCategoryTitleVerticalZoomView *categoryView;
@property (nonatomic, strong) JXCategoryListContainerView *listContainerView;
@property (nonatomic, strong) TeacherSquareController *squareViewController;
...
@implementation TeacherFindController
...
#pragma mark 懒加载
- (TeacherSquareController *)squareViewController{
    if (!_squareViewController) {
        _squareViewController = [[TeacherSquareController alloc] init];
