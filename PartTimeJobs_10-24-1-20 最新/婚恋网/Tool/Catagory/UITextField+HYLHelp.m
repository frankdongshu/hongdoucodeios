...
- (void)chgangePlaceholderColor:(NSString *)placeHolder;{
    ...
    attrs[NSForegroundColorAttributeName] = kRGBA(204, 204, 204, 1); // 设置颜色
...
- (UIView *)definImageViewTextTile:(NSString *)title width:(CGFloat)width heigth:(CGFloat)heigth{
    ...
    UIImageView *leftImage = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 40, 44)];
    leftImage.contentMode = UIViewContentModeCenter;
    leftImage.image = [UIImage imageNamed:title];
