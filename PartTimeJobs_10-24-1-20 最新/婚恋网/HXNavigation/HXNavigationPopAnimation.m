...
- (instancetype)init {
    if (self = [super init]) {
        ...
        self.shadowImageView.contentMode = UIViewContentModeScaleAspectFill;
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    self.maskImageView.image = [self.maskImageView.image imageWithTintColor:kNavigationBarColor];
