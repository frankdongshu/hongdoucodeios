...
- (void)pauseRecord {
  ...
  self.backgroundColor = [UIColor colorWithHex:0x3f80dd];
...
- (void)resaueRecord {
  ...
  [self setBackgroundColor:[UIColor colorWithHex:0xf47e7e]];
...
- (void)setup {
  ...
  if (!_microPhoneImageView) {
    ...
    microPhoneImageView.contentMode = UIViewContentModeScaleAspectFill;
  ...
  if (!_recordingHUDImageView) {
    ...
    recordHUDImageView.contentMode = UIViewContentModeScaleAspectFill;
