...
//    if ([friensModel.certification isEqualToString:@"1"]) { // 认证显示
...
- (void)darwUI{
    ...
    _cerBtn = ({
        ...
        [self.contentView addSubview:_cerBtn];
    ...
    _noLikeLabel = ({
        ...
        [self.contentView addSubview:_noLikeLabel];
