...
- (void)browerPhotoClick:(NSArray *_Nullable)picArrs withCurrentIndex:(NSInteger)index;
...
@property (weak, nonatomic) IBOutlet UILabel *shiRenLab;
@property (weak, nonatomic) IBOutlet UILabel *renLianLab;
