...
- (void)awakeFromNib{
    [super awakeFromNib];
    [_phoneNumberTF textFileTitle:@"phone" leftWidth:20 heigth:55];
    [_verityTF textFileTitle:@"mima" leftWidth:20 heigth:55];
...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event{
    if (_verityTF.isFirstResponder || _phoneNumberTF.isFirstResponder) {
