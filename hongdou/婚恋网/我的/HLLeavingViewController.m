...
- (void)uploadLeaving{
    ...
    WeakSelf(weakSelf);
    [HLHTTPSessionManager postDataWithNSString:HLLeave_Message withDictionary:@{@"uid":[LoginManager defaultManager].userid,@"message":self.textView.text} success:^(NSDictionary * _Nonnull dictionary) {
