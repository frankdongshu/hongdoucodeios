...
typedef NS_ENUM(NSUInteger, ZPHMessageType){
    ...
    ZPHMessageTypeCard /**< 名片消息 */,
    ZPHMessageTypeHtml /**< HTML消息 */,
    ZPHMessageTypeUnknow /**< 未知的消息类型 */,
};

@protocol ZPHMessageTableViewCellDelegate <NSObject>
...
@property (nonatomic,weak)id<ZPHMessageTableViewCellDelegate> delegate;
