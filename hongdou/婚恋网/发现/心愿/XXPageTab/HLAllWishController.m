...
@interface HLAllWishController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation HLAllWishController
...
- (void)loadNewData {
    ...
    [HLHTTPSessionManager postDataWithNSString:@"/product/allwish" withDictionary:params success:^(NSDictionary * _Nonnull dictionary) {
