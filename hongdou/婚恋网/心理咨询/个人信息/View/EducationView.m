...
- (void)getEducationViewList {
    ...
    [HLHTTPSessionManager postDataWithNSString:@"/mind/get_education" withDictionary:parmas success:^(NSDictionary * _Nonnull dictionary) {
        
        NSLog(@"/mind/get_education: %@",dictionary);
