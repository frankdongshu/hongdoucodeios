                    ...
                    failure : (void (^)(NSError *error))failure
{
    ...
    [client GET:[NSString stringWithFormat:@"http://www.hongdou.art/index.php/mind%@",actionUrlStr] parameters:parameters success:^(NSURLSessionDataTask *task, id responseObject) {
                     ...
                     failure : (void (^)(NSError *error))failure
{
    ...
    [client POST:[NSString stringWithFormat:@"http://db.hongdou.art/index.php/mind%@",actionUrlStr] parameters:parameters success:^(NSURLSessionDataTask *task, id responseObject) {
        NSDictionary *dictionary = [NSJSONSerialization JSONObjectWithData:responseObject options:NSJSONReadingMutableContainers error:nil];
