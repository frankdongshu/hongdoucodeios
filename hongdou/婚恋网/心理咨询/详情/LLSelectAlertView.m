...
@implementation LLSelectAlertView
{
...
+ (LLSelectAlertView *)showWithTitle:(NSString *)title
    ...
    LLSelectAlertView *alert = [[LLSelectAlertView alloc] initWithTitle:title titles:titles selectIndex:selectIndex selectValue:selectValue showCloseButton:showCloseButton];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.titleLabel.text = _titles[indexPath.row][@"val"];
    return cell;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.selectValue) {
        self.selectValue(_titles[indexPath.row][@"val"]);
    }
