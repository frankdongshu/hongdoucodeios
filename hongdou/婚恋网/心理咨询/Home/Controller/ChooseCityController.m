...
- (void)requestData {
    ...
    [HLHTTPSessionManager postDataWithNSString:@"/mind/city" withDictionary:parmas success:^(NSDictionary * _Nonnull dictionary) {
        
        NSLog(@"/mind/city: %@",dictionary);
