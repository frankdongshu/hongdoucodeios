...
@interface HZIAPManager()<SKPaymentTransactionObserver,SKProductsRequestDelegate> {
    ...
    NSString *_agentid;
    NSString *_productID;
    NSString *_productUrl; // 购买哪种功能Url
...
//    HDLog(@"-=>:%@",parmas);
    ...
    [HLHTTPSessionManager postDataWithNSString:_productUrl withDictionary:parmas success:^(NSDictionary * _Nonnull dictionary) {
        
        NSLog(@"%@: %@",self->_productUrl,dictionary);
